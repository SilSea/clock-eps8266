...
// =======================================================================
const char* ssid     = "wifi_name";     // SSID of local network
...
void showAnimClock()
{
  ...
  if (del == 0) {
    ...
    // เติมศูนย์นำหน้าสำหรับชั่วโมง
    String hourString = String(h, DEC);
    if (hourString.length() < 2) hourString = "0" + hourString;
    
    dig[0] = hourString.charAt(0) - '0'; // หลักสิบ
    dig[1] = hourString.charAt(1) - '0'; // หลักหน่วย
